...
public class TestOfMD4
{
    ...
    public void test()
    {
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.provider");
            throw new Error(x);
        }
        ...
        try
        {
            System.out.println("NOTE: This test may take a while.");
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.testMessageDigest");
        }
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.testAlphabet");
        }
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.testAsciiSubset");
        }
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.testEightyNumerics");
        }
        ...
        {
            x.printStackTrace();
            Assert.fail("TestOfMD4.testCloning");
        }
    }
}
